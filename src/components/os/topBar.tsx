...
export default function TopBar() {
  return (
    <div className="sticky top-0 z-40 flex flex-col gap-3 border-b border-[#1F2128] bg-bg-2/95 px-4 py-3 font-mono backdrop-blur-sm sm:flex-row sm:items-center sm:justify-between">
